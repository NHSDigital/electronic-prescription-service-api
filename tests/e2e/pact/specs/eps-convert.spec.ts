...
jestpact.pactWith(
  ...
  async (provider: any) => {
    ...
    describe("convert e2e tests", () => {
      const successfulCases = TestResources.convertCases.filter(convertCase => convertCase[4] === "200")
      const errorCases = TestResources.convertCases.filter(convertCase => convertCase[4] !== "200")
