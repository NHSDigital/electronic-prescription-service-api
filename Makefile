...
release:
	...
	rsync -av --progress --copy-links models dist/pact --exclude library/node_modules --exclude build
	rsync -av --progress --copy-links coordinator dist/pact --exclude node_modules --exclude pact
