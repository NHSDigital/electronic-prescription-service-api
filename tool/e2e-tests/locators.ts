...
export const hl7v3RequestExpander = By.xpath("//*[text() = '* - Equivalent hl7v3 that the FHIR API has sent to spine']")
export const hl7v3ResponseExpander = By.xpath("//*[text() = '* - The hl7v3 spine response that the FHIR API received from spine']")
export const fhirResponseExpander = By.xpath("//*[text() = '* - FHIR Response that a supplier will receive from the FHIR API']")
