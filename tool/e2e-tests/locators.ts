...
export const fhirRequestExpander = By.xpath("//*[text() = 'FHIR Request that a supplier would send to the FHIR API']")
export const fhirResponseExpander = By.xpath("//*[text() = 'Equivalent hl7v3 that the FHIR API has sent to spine']")
export const hl7v3RequestExpander = By.xpath("//*[text() = 'FHIR Response that a supplier will receive from the FHIR API']")
export const hl7v3ResponseExpander = By.xpath("//*[text() = 'The hl7v3 spine response that the FHIR API received from spine']")
