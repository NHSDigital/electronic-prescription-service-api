...
export const fhirRequestExpander = By.xpath("//*[text() = '1 - FHIR Request that a supplier would send to the FHIR API']")
export const fhirResponseExpander = By.xpath("//*[text() = '2 - Equivalent hl7v3 that the FHIR API has sent to spine']")
export const hl7v3RequestExpander = By.xpath("//*[text() = '3 - The hl7v3 spine response that the FHIR API received from spine']")
export const hl7v3ResponseExpander = By.xpath("//*[text() = '4 - FHIR Response that a supplier will receive from the FHIR API']")
