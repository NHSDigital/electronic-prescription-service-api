...
const statefulResourcesServiceName = app.node.tryGetContext("statefulResourcesServiceName")
...
Tags.of(app).add("statefulResourcesServiceName", statefulResourcesServiceName)
