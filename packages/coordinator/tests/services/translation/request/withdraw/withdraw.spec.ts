...
test("repeatInstanceInfo is mapped correctly", () => {
  ...
  expect(result.pertinentRepeatInstanceInfo.value._attributes.value).toEqual("4")
  expect(result.pertinentRepeatInstanceInfo.code._attributes.codeSystem).toEqual("2.16.840.1.113883.2.1.3.2.4.17.30")
  expect(result.pertinentRepeatInstanceInfo.code._attributes.code).toEqual("RPI")
})
