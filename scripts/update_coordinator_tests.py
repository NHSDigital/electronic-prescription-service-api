...
def main():
    ...
    convert_success_request_file_path = \
        "./models/examples/example-1-repeat-dispensing/SendRequest-FhirMessageSigned.json"
    with open(convert_success_request_file_path) as f:
        convert_success_request = json.load(f)

    convert_success_response_file_path = \
        "./models/examples/example-1-repeat-dispensing/ConvertResponse-Hl7V3Message.xml"
    ...
    prepare_success_request_file_path = \
        "./models/examples/example-1-repeat-dispensing/PrepareRequest-FhirMessageUnsigned.json"
    with open(prepare_success_request_file_path) as f:
        prepare_success_request = json.load(f)

    prepare_success_response_file_path = \
        "./models/examples/example-1-repeat-dispensing/PrepareResponse-FhirMessageDigest.json"
