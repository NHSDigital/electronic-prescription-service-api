...
API_RELEASE_PIPELINE_FILE='azure/azure-release-template.yml'
...
if [[ ${FAILED_CHECK} == 1 ]]; then
    ...
    echo "API_RELEAEE_PIPELINE_NODE_VERSION: ${API_RELEAESE_PIPELINE_NODE_VERSION}"
    echo "EPSAT_BUILD_PIPELINE_NODE_VERSION: ${EPSAT_BUILD_PIPELINE_NODE_VERSION}"
    echo "EPSAT_RELEASE_PIPELINE_NODE_VERSION: ${EPSAT_RELEAESE_PIPELINE_NODE_VERSION}"
