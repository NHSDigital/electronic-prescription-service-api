...
sed -i "s/^          LATEST_VALIDATOR_VERSION=.*/          LATEST_VALIDATOR_VERSION=${NEW_VALIDATOR_VERSION}/" .github/workflows/cdk_package_code.yml
sed -i "s/^LATEST_VALIDATOR_VERSION=.*/LATEST_VALIDATOR_VERSION=${NEW_VALIDATOR_VERSION}/" Makefile
