...
const fhirMessageUnsigned1 = JSON.parse(fhirMessageUnsigned1Str) as Bundle
const fhirMessageSigned1 = JSON.parse(fhirMessageSigned1Str) as Bundle
...
const fhirMessageUnsigned2 = JSON.parse(fhirMessageUnsigned2Str) as Bundle
const fhirMessageSigned2 = JSON.parse(fhirMessageSigned2Str) as Bundle
