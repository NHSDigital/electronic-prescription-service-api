...
import {ControlledDrugExtension, Dosage, MedicationRequest} from "../../../models/fhir/medication-request"
...
function convertDosageInstructions(dosageInstruction: Array<Dosage>) {
