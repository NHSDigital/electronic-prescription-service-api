    ...
    */
  {
    ...
    handler:
      (request: Hapi.Request, responseToolkit: Hapi.ResponseToolkit): Hapi.ResponseObject => {
        ...
        // 1. Validate shortFormId
        // 2. RBAC for user, reject if user not authorised
        // 3. Lookup Hl7v3 prescription
        // 4. Translate HL7v3 prescription to FHIR
        // 5. Replace response below with above translated FHIR prescription
        ...
        return responseToolkit
          ...
          .response({
            ...
            "identifier": {
              ...
              "value": "a11a6118-634e-4e7e-a01b-cc2addb1b993"
            },
            "type": "message",
            "entry": [
              {
                    ...
                    "extension": [
                      {
                        ...
                        "valueIdentifier": {
                          ...
                          "value": "c59b0ad3-b6c9-49f1-a50a-0595b97c503d"
                        }
                      }
                    ],
                    "system": "https://fhir.nhs.uk/Id/prescription-order-number",
                    "value": request.params.shortFormId
                  },
                  "courseOfTherapyType": {
                    "coding": [
                      {
              ...
              },
              {
                ...
                "resource": {
                  ...
                  "recorded": "2021-02-11T16:32:11+00:00",
                  "agent": [
                    {
                      "who": {
                        "reference": "urn:uuid:56166769-c1c4-4d07-afa8-132b5dfca666"
                  ...
                  "signature": [
                    {
                      ...
                      "when": "2021-05-07T14:47:56+00:00",
                      "who": {
                        "reference": "urn:uuid:56166769-c1c4-4d07-afa8-132b5dfca666"
                      },
